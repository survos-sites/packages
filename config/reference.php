 ...
 * @psalm-type ZenstruckTwigServiceConfig = array{
 *     functions?: list<mixed>,
 * }
 ...
 *     version?: scalar|null, // Default: 1
 *     db?: scalar|null, // Default: "db"
 *     stores?: list<array{ // Default: []
 *         batch?: int, // batch size when loading api // Default: null
 *         name?: scalar|null, // the store name
 *         schema?: scalar|null, // the index definition
 *         url?: scalar|null, // the API to use to load if empty. json-ld iterates through pages
 *         response_key?: scalar|null, // key if API returns an object response, e.g. dummyjson returns {'products': [...]}
 *     }>,
 * }
 ...
 *     zenstruck_twig_service?: ZenstruckTwigServiceConfig,
