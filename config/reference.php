 ...
 *     version?: scalar|null|Param, // Default: 1
 *     db?: scalar|null|Param, // Default: "db"
 *     stores?: list<array{ // Default: []
 *         batch?: int|Param, // batch size when loading api // Default: null
 *         name?: scalar|null|Param, // the store name
 *         schema?: scalar|null|Param, // the index definition
 *         url?: scalar|null|Param, // the API to use to load if empty. json-ld iterates through pages
 *         response_key?: scalar|null|Param, // key if API returns an object response, e.g. dummyjson returns {'products': [...]}
 *     }>,
 * }
